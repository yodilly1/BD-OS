...
4.  **Add a Database**:
    ...
    - _Note: We updated the code to automatically use this Postgres DB instead of SQLite._
...
3.  Go to **Variables**:
    ...
    - _You can find the Backend URL in the Backend service -> Settings -> Networking -> Public Networking._
